...
describe Vayacondios::Client, events: true, stashes: true do
  ...
  describe "#announce" do
    ...
    context "with only a topic argument" do
      it "raises an error" do
        expect { subject.announce(topic) }.to raise_error(ArgumentError)
      end
    end
  ...
  describe "#set" do
    ...
    context "with only a topic argument" do
      it "raises an error" do
        expect { subject.set(topic) }.to raise_error(ArgumentError)
      end
    end

    context "with only topic and ID arguments" do
      it "raises an error" do
        expect { subject.set(topic, id) }.to raise_error(ArgumentError)
      end
    end

    context "with topic, ID, and a document" do
      it "raises an error" do
  ...
  describe "#delete" do
    ...
    context "with a topic and an ID" do
      it "deletes the value statshed for the given ID within the given topic" do
